...
class RecorderWithCallback:
    ...
    def __init__(self, config, device, filename, align_depth_to_color):
        ...
        self.recorder = o3d.open3d.io.AzureKinectRecorder(config, device)
    ...
    def run(self):
        glfw_key_escape = 256
        glfw_key_space = 32
        vis = o3d.open3d.visualization.VisualizerWithKeyCallback()
        ...
        while not self.flag_exit:
           ...
           # vis2 = o3d.open3d.visualization.VisualizerWithKeyCallback()
            vis.update_geometry()
